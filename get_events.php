...
<!-- Simple Lightbox -->
<div id="lightbox" class="hidden fixed inset-0 z-[1000] p-6 flex flex-col items-center justify-center transition-all duration-500 opacity-0 bg-slate-950/95 backdrop-blur-xl">
