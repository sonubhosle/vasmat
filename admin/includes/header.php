...
<body class="min-h-screen text-slate-900 overflow-x-hidden selection:bg-primary-100 selection:text-primary-700">
    ...
    <!-- Sidebar Wrapper -->
    <aside id="admin-sidebar" class="fixed top-0 left-0 h-screen w-[280px] bg-secondary z-[50] sidebar-transition sidebar-hidden md:translate-x-0 border-r border-slate-800/10 shadow-2xl">
        <div class="h-full flex flex-col p-8">
            ...
            <div class="mt-auto pt-8 border-t border-white/5">
                <a href="/vasmat/auth/logout.php" class="flex items-center gap-3 px-5 py-4 rounded-2xl text-xs font-black uppercase tracking-widest text-rose-400 bg-rose-500/5 hover:bg-rose-500 hover:text-white transition-all shadow-lg shadow-rose-500/0 hover:shadow-rose-500/20">
    ...
    <div class="md:pl-[280px] w-full min-h-screen flex flex-col transition-all duration-300">
        ...
        <header class="sticky top-0 z-[30] glass px-8 py-5 flex items-center justify-between w-full">
            <div class="flex items-center gap-8 flex-1">
                ...
                <div class="hidden lg:flex items-center max-w-md w-full relative group">
                    <i class="fas fa-magnifying-glass absolute left-5 text-slate-400 text-sm group-focus-within:text-primary-500 transition-colors"></i>
                    <input type="text" placeholder="Search for faculties, events, syllabus..." 
                           class="w-full bg-slate-50 border-none rounded-2xl py-3.5 pl-12 pr-6 text-sm font-bold text-slate-700 placeholder:text-slate-400 focus:ring-2 focus:ring-primary-500/20 transition-all shadow-inner">
                </div>
            </div>
            ...
            <div class="flex items-center gap-6">
                ...
                <button class="w-12 h-12 flex items-center justify-center bg-white border border-slate-200 rounded-2xl text-slate-400 hover:text-primary-600 transition-all relative">
