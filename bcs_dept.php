...
<div class="px-6 py-12 ">
    ...
    <div class="mb-16 animate-fade-in-up">
        <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-50 border border-amber-100 text-amber-600 text-[10px] font-black uppercase  mb-6">
            <i class="fas fa-university"></i> Academic Department
        </div>
        <h1 class="text-3xl font-black text-slate-900 mb-6 tracking-tight">
            Department of <br> <span class="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-orange-600"> B.Sc. (Comp. Sci.)</span>
        </h1>
        <p class="text-slate-500 text-lg max-w-2xl font-medium">Access all academic materials, schedules, and official communications for Bachelor of Science in Computer Science.</p>
    </div>
