        ...
        <section class="right-panel">
            <div class="auth-card fade-in">
                <div class="auth-header">
                    ...
                    <p>Enter your details to manage the institution.</p>
                </div>
                ...
                <form action="" method="POST" class="space-y-6">
                    ...
                    <div class="flex justify-end mb-6">
                        <a href="forgot-password.php?role=admin" class="text-xs font-bold text-indigo-600 hover:underline">Forgot password?</a>
                    </div>
                ...
                <div class="footer-links">
                    <p class="text-sm text-slate-500 font-medium">New administrator? <a href="admin-register.php" class="text-indigo-600 font-bold hover:underline">Request Account</a></p>
                </div>
            </div>
        </section>
    </div>
